...
export class SoulboundNft extends ethereum.SmartContract {
  static bind(address: Address): SoulboundNft {
    return new SoulboundNft("SoulboundNft", address);
  }

  achievementToken(param0: Address, param1: Bytes): BigInt {
    let result = super.call(
      "achievementToken",
      "achievementToken(address,bytes32):(uint256)",
      [
  ...
  hasAchievement(user: Address, achievement: Bytes): boolean {
    let result = super.call(
      "hasAchievement",
      "hasAchievement(address,bytes32):(bool)",
      [
        ethereum.Value.fromAddress(user),
        ethereum.Value.fromFixedBytes(achievement),
      ],
    );
  ...
  issue(to: Address, tokenURI: string, achievement: Bytes): BigInt {
    let result = super.call(
      "issue",
      "issue(address,string,bytes32):(uint256)",
      [
  ...
  tokenAchievement(param0: BigInt): Bytes {
    let result = super.call(
      "tokenAchievement",
      "tokenAchievement(uint256):(bytes32)",
  ...
  try_tokenAchievement(param0: BigInt): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "tokenAchievement",
      "tokenAchievement(uint256):(bytes32)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
